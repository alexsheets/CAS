        ...
        public ActionResult SignIn(SignIn credentials)
        {
            try
            {
                ...
                else
                {
                    ...
                    GroupPrincipal rothStG = GroupPrincipal.FindByIdentity(cntxt, "VMED-STU-RossGeorgeIsland");
                    ...
                    if (isValid)
                    {
                        ...
                        if (usr.IsMemberOf(rothStG) || usr.IsMemberOf(gradStudents) || usr.IsMemberOf(studentGroup28) || usr.IsMemberOf(studentGroup27) || usr.IsMemberOf(studentGroup26) || usr.IsMemberOf(studentGroup25) || usr.IsMemberOf(studentGroup24) || usr.IsMemberOf(studentGroup23))
                        {
                            isStudent = true;
                        }
