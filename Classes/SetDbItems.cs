    ...
    public class SetDbItems
    {
        ...
        public string AddEvaluatorImports(List<Evaluator> evaluators)
        {
            try
            {
                foreach (var newEvaluator in evaluators)
                {
                    ...
                    newEvaluator.FullName = evaluator.FirstName + " " + evaluator.LastName;
        ...
        public string CreateEvaluator(Evaluator evaluator)
        {
            try
            {
                ...
                // evaluator.FullName = evaluator.FirstName + " " + evaluator.LastName;
        ...
        public string CreateResultItems(List<ResultItem> items)
        {
            try
            {
                foreach (var item in items)
                {
                    ...
                    resultItem.ResultId = item.ResultId;
        ...
        public string ApproveExternship(ExternshipRegistration externship)
        {
            try
            {
                externship.Visibility = 1;
                externship.Approved = 1;
                _dbContext.ExternshipRegistration.Update(externship);
                _dbContext.SaveChanges();
                return "SUCCESS!";
            }
